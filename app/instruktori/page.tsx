  ...
  return (
    <div className="shell page-container animate-entrance">
      <header className="page-head">
        <p className="eyebrow">Екип & Опит</p>
        <h2>Сертифицирани специалисти в прецизното движение</h2>
        <p>
          Всеки час се води от опитен инструктор, който познава спецификите на тялото ви,
          следи за правилната стойка и настройва уреда за оптимални и видими резултати.
        </p>
      </header>
