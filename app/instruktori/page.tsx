...
const TEAM: {
...
}[] = [
  {
    ...
    bio: "Магистър по кинезитерапия с над 8 години опит. Специализира във функционалното възстановяване, постуралната корекция и основите на уреда реформър.",
    focus: ["Рехабилитация", "Основи на реформър", "Постурална корекция"],
  ...
  return (
    <div className="shell page-container animate-entrance">
      <header className="page-head">
        ...
        <h2>Сертифицирани инструктори с кинезитерапевтичен опит</h2>
        <p>
