...
const FAQS = [
  ...
  },
  {
    ...
    a: "Напълно безопасно. Инструкторите в Реформанс са сертифицирани пилатес специалисти с опит в работата при специфични нужди на гърба. Преди началото на часа уточняваме вашите състояния и адаптираме всяко движение за пълна безопасност.",
  },
  {
    q: "Защо има само 6 реформъра в залата?",
    a: "Защото това е оптималният брой хора, при който един инструктор може да следи всяко повторение на всеки трениращ. При нас няма масови класове от 15-20 души — тук получавате персонално внимание през всички 50 минути.",
  },
  {
  ...
  {
    q: "Как мога да откажа или преместя час, ако ми изскочи ангажимент?",
    a: "Отказването или преместването е 100% безплатно до 12 часа преди началния час през онлайн системата за резервации или с кратко съобщение по Viber. Без излишни такси или неустойки.",
  },
];
        ...
        return (
          ...
          >
            ...
            >
              ...
              >
                <ChevronDownIcon size={20} color="var(--plum-dark)" />
              </span>
            </div>
            {isOpen && (
              <p
